...
# جستجو در Google + Startpage + DuckDuckGo Lite
...
def multi_search(q, only_ir=True, engine_order=("google","startpage","ddg_lite"), need=60):
    pool = []
